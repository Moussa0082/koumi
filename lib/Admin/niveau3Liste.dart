...
class Niveau3Liste extends StatefulWidget {
  final Niveau2Pays niveau2pays;
  const Niveau3Liste({super.key, required this.niveau2pays});

  @override
  State<Niveau3Liste> createState() => _Niveau3ListeState();
}
...
class _Niveau3ListeState extends State<Niveau3Liste> {
  ...
  Future<List<Niveau3Pays>> getSousListe() async {
                                                                          ...
                                                                          (value) =>
                                                                              {
                                                                                ...
                                                                                setState(() {
                                                                                  _liste = Niveau3Service().fetchNiveau3ByNiveau2(widget.niveau2pays.idNiveau2Pays!);
                                                                                }),
                                                                                Navigator.of(context).pop(),
