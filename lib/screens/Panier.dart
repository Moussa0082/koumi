...
class _PanierState extends State<Panier> {
 ...
 List<CartItem> cartItems = [];
  ...
  List<Stock> stocks = cartItems.map((cartItem) {
    return Stock(
      idStock: cartItem.stock.idStock, // Assuming stock is a property in CartItem
      quantiteStock: cartItem.quantiteStock.toDouble(), // Assuming quantiteStock is of type double
    );
  }).toList();
  ...
  try {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Une erreur est survenue. Veuillez réessayer ultérieurement.'),
      ),
    );
  }
      print('Erreur lors de l\'ajout de la commande: ${response.body}');
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                         ...
                         if(cartProvider.cartItems.isNotEmpty){
                          ...
                          Snack.error(titre: "Alerte", message: "Veuiller ajouté au moins 1 produits à votre panier");
                         }
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
