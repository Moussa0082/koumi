...
class _DetailCommandeScreenState extends State<DetailCommandeScreen> { 
  ...
  void initState() {
    super.initState();
    futureDetails = CommandeService().fetchDetailsCommande(widget.idCommande!);
  }
              ...
              child: FutureBuilder<List<DetailCommande>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    debugPrint('Erreur lors du chargement des détails: ${snapshot.error}');
                    debugPrint('Détails de l\'erreur: ${snapshot.error.runtimeType}');
                ...
                try {
                  if (_quantiteLivrerController.text.isEmpty) {
                    Snack.error(titre: "Alerte", message: "Veuillez remplir le champ quantité livrée");
                    return;
                  }
              
                  double quantiteLivree = double.parse(_quantiteLivrerController.text);
                  String message = await CommandeService().confirmerLivraison(details[index].idDetailCommande!, quantiteLivree);
                              ...
                              if (details[index].stock != null)
                                ClipRRect(
                                  ...
                                  child: details[index].stock!.photo != null
                                      ? CachedNetworkImage(
                                          imageUrl: "https://koumi.ml/api-koumi/Stock/${details[index].stock!.idStock!}/image",
                                          fit: BoxFit.cover,
                                          width: 50,
                                          height: 80,
                                          placeholder: (context, url) => const Center(child: CircularProgressIndicator()),
                                          errorWidget: (context, url, error) => Image.asset("assets/images/default_image.png", width: 50, height: 80),
                                        )
                                      : Image.asset("assets/images/default_image.png", width: 50, height: 80),
                                )
                              else if (details[index].intrant != null)
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(8),
                                  child: details[index].intrant!.photoIntrant != null
                                      ? CachedNetworkImage(
                                          imageUrl: "https://koumi.ml/api-koumi/intrant/${details[index].intrant!.idIntrant}/image",
                                          fit: BoxFit.cover,
                                          width: 50,
                                          height: 80,
                                          placeholder: (context, url) => const Center(child: CircularProgressIndicator()),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        widget.isProprietaire == true &&  details[index].quantiteDemande!.toInt() != details[index].quantiteLivree!.toInt() && details[index].description == null ? ElevatedButton(
                                          onPressed: () {
                                            showDialog(
                                              context: context,
                                              builder: (context) {
                                                return AlertDialog(
                                                  ...
                                                  content: TextField(
                                                   ...
                                                   controller: _quantiteLivrerController,
                                                    decoration: InputDecoration(
                                                      hintText: 'Quantité livrée',
                                                    ),
                                     ...
                                     if(_quantiteLivrerController.text.isEmpty){
                                     Snack.error(titre: "Alerte", message: "Veuiller remplir le champ quantité demandé");
                                     return;
                                     }else{
                                                         _handleButtonPress().then((value) => {
                                                          setState(() {
                                                            isLoading = false;
                                                         })
                                                         });
                                                     ...
                                                     Expanded(
                                                       child: TextButton(
                                                                 onPressed: () {
                                                                   Navigator.of(context).pop();
                                                                   _showCancelConfirmationDialog(details[index].idDetailCommande!);
                                                                 },
                                                                 child: Text('Annuler Livraison' , overflow: TextOverflow.ellipsis, style:TextStyle(overflow: TextOverflow.ellipsis)),
                                                               ),
                                                     ),
                                                  ]),
                                                  ],
                                    ...
                                    details[index].description == null  ? 
                                        Row(
                                          children: [
                                            Text("Confirmé",style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Italic"),),
               ...
               height: 40,
                 child: Center(
                   child:Lottie.asset("assets/anim.json"),
                                        ...
                                        Row(
                                          children: [
                                            Text("Annulé",style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Italic"),),
                                            const SizedBox(width: 5,),
                                            Container(
                width: 40,
               height: 40,
                ...
                children: [
                  ...
                  Text(
                    "Total des sommes : ${details.fold(0.0, (sum, item) {
                      num? prix = item.stock != null ? item.stock!.prix : item.intrant != null ? item.intrant!.prixIntrant : 0.0;
                                                ...
                                                actions: [
                                                  ...
                                                  TextButton(
                                                    onPressed: () async{
                                                       ...
                                                       _handleButtonPressAnnulerLivraison().then((value) => {
                                                        setState(() {
                                                          isLoading = false;
                                                       })
                                                       });
