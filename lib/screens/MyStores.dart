  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Vous pouvez afficher une image ou un texte ici
                      if(magasinListe.isEmpty || magasinListe.isEmpty && _searchController.text.isNotEmpty){   
                                      ...
                                      //         "Localité :", filtereSearch[index].localiteMagasin!),
                                          ...
                                          //     "Acteur :", e.acteur!.typeActeur!.map((e) => e.libelle!).join(','))
                                           Padding(
                                               ...
                                               children: [
                                                 _buildEtat(filtereSearch[index].statutMagasin!),
                                                 SizedBox(width: 120,),
                                                 Expanded(
                                                   child: PopupMenuButton<String>(
                                                     ...
                                                     itemBuilder: (context) =>
                                                       ...
                                                       PopupMenuItem<String>(
                                                         child: ListTile(
                                                           leading: filtereSearch[index].statutMagasin == false ? Icon(
                                                             Icons.check,
                                                             color: Colors.green,
                                                           ): Icon(
                                                           ...
                                                           title:  Text(
                                                            filtereSearch[index].statutMagasin == false ? "Activer" : "Desactiver",
                                                             style: TextStyle(
                                                               color: filtereSearch[index].statutMagasin == false ? Colors.green : Colors.red,
                                                               fontWeight: FontWeight.bold,
                                                             ),
                                                           ),
                                                           ...
                                                           onTap: () async {
                                                                          ...
                                                                          filtereSearch[index].statutMagasin == false ?  await MagasinService().activerMagasin(filtereSearch[index].idMagasin!).then((value) => {
                                                                 ...
                                                                 .desactiverMagasin(filtereSearch[index].idMagasin!)
                                                                 .then((value) => {
                                                                    Provider.of<MagasinService>(
                                                                        context,
                                                                        listen:
                                                                         ...
                                                                         child: ScaleTransition(
                                                                           ...
                                                                           child: AddMagasinScreen(
                                                                             ...
                                                                             nomMagasin:
                                                                                 filtereSearch[index].nomMagasin,
                                                                             contactMagasin:
                                                                                 filtereSearch[index].contactMagasin,
                                                                             localiteMagasin:
                                                                                 filtereSearch[index].localiteMagasin,
                                                                             niveau1Pays:
                                                                                 filtereSearch[index].niveau1Pays!,
