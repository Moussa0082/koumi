  ...
  Future<List<Stock>> getAllStocksByMagasinAndActeur() async {
    if (selectedCat != null && widget.id != null) {
      stockListe = await StockService()
          .fetchProduitByCategorieProduitMagAndActeur(
              selectedCat!.idCategorieProduit!, widget.id!, acteur.idActeur!);
    } else if (selectedCat != null) {
      stockListe = await StockService().fetchProduitByCategorieAndActeur(
