...
class _ProduitActeurScreenState extends State<ProduitActeurScreen>
 ...
 //Non implementé en spring api
  ...
  //     final response = await http.get(
  //         // Uri.parse('https://koumi.ml/api-koumi/Stock/categorieAndActeur/$idCategorie/$idMagasin/$idActeur'));
  //         Uri.parse('http://10.0.2.2:9000/api-koumi/Stock/categorieAndActeur/$idCategorie/$idActeur'));
  //      if (response.statusCode == 200) {
  //       final String jsonString = utf8.decode(response.bodyBytes);
  //       List<dynamic> data = json.decode(jsonString);
  //       setState(() {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          selectedCategorieProduitNom = categorieProduit.isNotEmpty
              ...
              : '';
    isExist ? fetchProduitByCategorie(selectedCategorieProduit, widget.id!, acteur.idActeur!) : null;
        });
        debugPrint(
