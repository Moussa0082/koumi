        ...
        setState(() {
         categorieProduit = data
          ...
          selectedCategorieProduitNom = categorieProduit.isNotEmpty
              ...
              : '';
    widget.id != null   ? fetchProduitByCategorie(selectedCategorieProduit, widget.id, acteur.idActeur!) : fetchProduitByCategorieAndActeur(selectedCategorieProduit, acteur.idActeur!);
        });
        debugPrint(
