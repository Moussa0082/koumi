...
class _AddAndUpdateProductEndSreenState
  ...
  void initState() {
    ...
    zoneListe = http
        .get(Uri.parse('https://koumi.ml/api-koumi/ZoneProduction/getAllZone'));
    ...
    debugPrint(
        "nom : ${widget.nomProduit}, forme: ${widget.forme}, origine : ${widget.origine}, qte : ${widget.quantite}, prix : ${widget.prix}");
  }
                            ...
                            if (snapshot.hasData) {
                              ...
                              if (responseData is List) {
                                ...
                                return DropdownButtonFormField<String>(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: widget.stock!.speculation!
                                                .nomSpeculation ==
                                            null
                                  ...
                                  onChanged: (newValue) {
                                    setState(() {
                                      zoneProduction.idZoneProduction =
                                          newValue;
                                      if (newValue != null) {
                                        zoneProduction.nomZoneProduction =
                                            zoneListe
                                                .map(
                                                    (e) => e.nomZoneProduction!)
                                                .first;
                                        print(
                                            "zone de production : ${speculation}");
                                      }
                                    });
                                  },
                                  decoration: InputDecoration(
                                    labelText: widget.stock!.zoneProduction!
                                                .nomZoneProduction ==
                                            null
