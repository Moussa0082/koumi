...
class _CarrouselState extends State<Carrousel> {
  ...
  void initState() {
    ...
    verify();
    getLocation();
    fetchAlertes(detectedCountry != null ? detectedCountry! : "Mali")
        .then((alerts) {
      if (mounted) {
        setState(() {
          alertesList = alerts;
...
//     super.initState();
//     getLocation();
//     fetchAlertesOffLine(detectedCountry != null ? detectedCountry! : "Mali")
//         .then((alerts) {
//       if (mounted) {
//         setState(() {
//           alertesList = alerts;
...
//     try {
//       final response = await http.get(Uri.parse(
//           '$baseUrl/getAlertesOffLineByPaysAndNotWithPagination?niveau3PaysActeur=$pays&page=$page&size=$size'));
...
//   List<Widget> getImageSliders(
//       List<AlertesOffLine> alertesList, List<Map<String, String>> imageListe) {
...
// //       entry.value['image_path'] ?? 'assets/images/alert_default.jpg',
// //       '',
// //       entry.key,
// //       []
// //     )).toList();
...
// //       "https://koumi.ml/api-koumi/alertesOffLine/${entry.value.idAlerteOffLine}/image" : 'assets/images/alert_default.jpg',
// //       entry.value.titreAlerteOffLine ?? '',
// //       entry.key,
// //       alertesList
// //     )).toList();
...
//               borderRadius: BorderRadius.circular(
//                   20.0), // Bordure arrondie pour les coins des images
//               child: alertesList[index].photoAlerteOffLine!.isNotEmpty
//                   ? CachedNetworkImage(
//                       imageUrl: imagePath,
//                       placeholder: (context, url) =>
//                           const Center(child: CircularProgressIndicator()),
...
//                   child: Row(
//                     mainAxisAlignment: MainAxisAlignment.center,
//                     children: (alertesList.isEmpty && isLoading == false
//                             ? imageList
//                             : alertesList)
//                         .asMap()
//                         .entries
