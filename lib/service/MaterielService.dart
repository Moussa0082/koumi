...
//   Future<List<Materiel>> fetchMateriele(String pays, String libelleFiliere,
//       {bool refresh = false}) async {
//     if (isLoading == true) return [];
...
//       if (response.statusCode == 200) {
//         // final jsonData = jsonDecode(utf8.decode(response.bodyBytes));
//         var jsonData= await json.decode(utf8.decode(response.bodyBytes));
//         final List<dynamic> body = jsonData['content'];
...
//   Future<List<Materiel>> fetchMaterielByTypeAndPaysWithPagination(
...
//       debugPrint(
//            ' service : $apiOnlineUrl/Materiel/getAllMaterielsByTypeMaterielWithPagination?idTypeMateriel=${idTypeMateriel}&page=$page&size=$size');
//       if (response.statusCode == 200) {
//         final jsonData = jsonDecode(utf8.decode(response.bodyBytes));
//         final List<dynamic> body = jsonData['content'];
...
//   Future<List<Materiel>> fetchMaterielByTypeAndFiliere(
...
// //voir
//   Future<List<Materiel>> fetchMaterielByActeurWithPagination(String idActeur,
//       {bool refresh = false}) async {
//     if (isLoading) return [];
